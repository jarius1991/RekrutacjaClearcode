...
def count_power(soldier,type):
    ...
    """
    if soldier<0:
       return - bin(soldier)[3:].count(str(type)) # Solve saboteur and spies problem
    else:
       return bin(soldier)[2:].count(str(type))
